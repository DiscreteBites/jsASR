...
def predictPhonemeProbabilitiesNonCausalNN( 
    filename_X: str,
    filename_Y: str, 
    model_name: str, 
    ...
    p_now  = p[1]
    p_next = p[2]
    np.save( file_identifier_out + '_p_prev.npy',p_prev )
    np.save( file_identifier_out + '_p_now.npy', p_now  )
    np.save( file_identifier_out + '_p_next.npy',p_next )
